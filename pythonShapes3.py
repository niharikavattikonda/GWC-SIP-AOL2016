...
shape = input("Type 'square' if you want to draw a square and 'triangle' if you want to draw an equilateral triangle ")
length = int(input("Length of one side of the shape: "))
pencolor = input("What pen color do you want? ")
goto(10, 10)

def square(length, pencolor):
    pendown()
...
if shape == "square":
    square(length, pencolor)

if shape == "triangle":
    triangle(length, pencolor)
