...
class Scroller(object):
    ...
    def add_buildings(self):
        ...
        while current_width <= self.width:
            new_building = self.add_building(current_width)
            current_width += new_building.width
    ...
    def add_building(self, x_location):
        ...
        put a buildng.
        returns a new building at that spot
        """
        ...
        return Building(x_location, y_location, building_width, building_height, self.color)
    ...
    def move_buildings(self):
        ...
        new_building = self.add_building(new_building_location)
        self.buildings.append(new_building)
